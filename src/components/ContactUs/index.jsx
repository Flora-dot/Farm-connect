    ...
    <div className={styles.container}>
      ...
      <div className={styles.wrapper}>
        ...
        <p className={styles.emailHeader}>
          <span>Email enquiries</span> <br />
          Need help with your order? Drop us an email and our lovely Customer
          Care team will be happy to help.
        </p>
        ...
        <div className={styles.inputFeild}>
          <p>
            <span>Alternatively, fill out our contact form </span>
            <br />
            We aim to respond to all customer enquiries within 48 hours, Monday
            to Friday.
          </p>
          <form action="">
            ...
            <label htmlFor="message" className={styles.labelTxt}>
              Write a message
            </label>{" "}
            <br />
